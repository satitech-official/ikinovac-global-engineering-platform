...
function Header() {
  ...
  return <>
    ...
    <div className="header-signal"><span>Africa-focused industrial sourcing backed by global engineering capability.</span><Link href="/contact">Start a project <b>↗</b></Link></div>
...
function Footer() {
  return <footer className="site-footer-v2">
    ...
    <div className="footer-grid"><section><p className="eyebrow light">PRODUCTS</p><Link href="/products">Product directory</Link><Link href="/products/valves">Valves</Link><Link href="/products/automation">Automation</Link><Link href="/products/pipe-fittings-flanges">Pipe &amp; fittings</Link></section><section><p className="eyebrow light">EXPLORE</p><Link href="/industries">Industries</Link><Link href="/solutions">Solutions</Link><Link href="/global-presence">Global presence</Link><Link href="/insights">Knowledge hub</Link></section><section><p className="eyebrow light">AFRICA MARKETS</p><Link href="/global-presence/africa">Africa overview</Link><Link href="/global-presence/south-africa">South Africa</Link><Link href="/global-presence/nigeria">Nigeria</Link><Link href="/global-presence/kenya">Kenya</Link><Link href="/global-presence/egypt">Egypt</Link><Link href="/global-presence/ghana">Ghana</Link><Link href="/global-presence/tanzania">Tanzania</Link></section><section><p className="eyebrow light">CONTACT</p><a href="mailto:info@ikinovac.com">info@ikinovac.com</a><Link href="/contact">Start an enquiry</Link></section></div>
