  ...
  return (
    <main>
      ...
      <header className="site-header">
        ...
        <div className="main-nav">
          <a className="brand" href="#home" aria-label="IKINOVAC Global home" onClick={() => goTo("home")}>
            <span className="brand-mark"><img src={publicAsset("brand/ikinovac-logo-readable.png")} alt="IKINOVAC Global — Engineering Solutions. Global Impact." /></span>
          </a>
      ...
      <section id="company" className="company-section section-shell dark-section">
        <div className="company-media"><div className="company-photo"><img className="company-logo-image" src={publicAsset("brand/ikinovac-logo-readable.png")} alt="IKINOVAC Global — Engineering Solutions. Global Impact." /></div><div className="media-annotation"><span>EST.</span><strong>ENGINEERING-LED</strong><p>GLOBAL / RESPONSIVE / RELIABLE</p></div><div className="corner-frame" /></div>
