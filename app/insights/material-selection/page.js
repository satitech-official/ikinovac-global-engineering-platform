...
export const metadata = {
  ...
  alternates: { canonical: '/insights/material-selection' },
...
export default function Page() {
  const articleSchema = {
    ...
    mainEntityOfPage: 'https://satitech-official.github.io/ikinovac-global-engineering-platform/insights/material-selection'
  };
  return <PublicPage>
