...
function Logo({ light = false }) {
  return <a className={`brand ${light ? 'brand-light' : ''}`} href="#home" aria-label="IKINOVAC GLOBAL home">
    <span className="brand-icon"><img src="/assets/ikinovac-logo.jpeg" alt="IKINOVAC GLOBAL" /></span>
  ...
  return <main id="home">
    <div className="site-frame">
      ...
      <section className="editorial-grid">
        <article className="editorial-image image-tall"><div /><span>FIELD NOTE / 01</span></article>
        ...
        <article className="editorial-image image-wide"><div /><span>FIELD NOTE / 02</span></article>
      </section>
      ...
      <section className="systems-section" id="systems">
        ...
        <div className="systems-layout">
          ...
          <article className="system-feature">
            <div className="system-photo" style={{ backgroundImage: `url(${selectedSystem.image})` }}><span>{selectedSystem.number}</span></div>
      ...
      <footer className="site-footer"><div><Logo light /><p>ENGINEERING PRODUCTS.<br />GLOBAL PROCUREMENT.<br />TECHNICAL CLARITY.</p></div><div><a href="/admin">Open operations workspace <Arrow /></a><button onClick={() => scrollTo('home')}>Back to top ↑</button></div><small>© {new Date().getFullYear()} IKINOVAC GLOBAL — Engineering solutions. Global impact.</small></footer>
    </div>
