...
export const insights = [
  ['valve-selection', 'Valve Selection', 'Industrial Valve Selection Guide for Project Buyers', 'Prepare a clearer valve RFQ with service conditions, pressure, temperature, material, actuation, documentation and delivery requirements.'],
  ['material-selection', 'Material Selection', 'Material Specification Checklist for Industrial Sourcing', 'Communicate material grades, standards, traceability, service conditions and project constraints without relying on supplier assumptions.'],
  ['procurement', 'Procurement', 'Global Engineering Procurement RFQ Checklist', 'Connect technical scope, quantities, documentation, commercial expectations, logistics and delivery context in one clearer RFQ.'],
  ['ball-valve-vs-gate-valve', 'Valve Selection', 'Ball Valve vs Gate Valve: Industrial Selection Guide', 'Compare operating function, shut-off behavior, actuation and RFQ requirements before evaluating industrial valve options.'],
  ['oil-gas-procurement-checklist', 'Oil & Gas Procurement', 'Oil & Gas Procurement Checklist for International Projects', 'Structure project sourcing around specifications, approved vendors, inspection, documentation, logistics and delivery requirements.'],
  ['piping-flange-rfq-guide', 'Piping Procurement', 'Pipe, Fittings & Flange RFQ Guide for Industrial Buyers', 'Prepare piping RFQs with size, schedule, material, pressure class, standards, documentation and delivery requirements.']
